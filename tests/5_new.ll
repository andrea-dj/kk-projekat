...
for.body3:                                        ; preds = %for.cond1
  %shl_by_pow22 = shl i32 %j.0, 2
  %add_for_mul = add i32 %j.0, %j.0
  %add_for_mul1 = add i32 %add_for_mul, %j.0
  %add = add nsw i32 %shl_by_pow22, %add_for_mul1
...
for.end:                                          ; preds = %for.cond1
  %shl_by_pow2 = shl i32 %inner_sum.0, 1
  %add7 = add nsw i32 %sum.0, %shl_by_pow2
  br label %for.inc8
